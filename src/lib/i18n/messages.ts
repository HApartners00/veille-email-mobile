...
const fr = {
  ...
  feed: {
    ...
    emptyDefault: 'Les emails apparaîtront ici à la prochaine relève.',
  ...
  sources: {
    ...
    connectBody:
      'Autorisez l’accès à votre boîte via la connexion officielle {auth}, puis vous reviendrez ici.',
...
const en: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'Emails will appear here at the next sync.',
    folderInbox: 'Inbox',
  ...
  sources: {
    ...
    connectBody:
      'Authorize access to your mailbox via the official {auth} sign-in, then you’ll come back here.',
  ...
  settings: {
    ...
    language: 'Language',
    languageHint: 'Language of the app.',
...
const es: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'Los correos aparecerán aquí en la próxima sincronización.',
  ...
  sources: {
    ...
    connectBody:
      'Autoriza el acceso a tu buzón mediante el inicio de sesión oficial de {auth} y luego volverás aquí.',
...
const de: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'E-Mails erscheinen hier bei der nächsten Synchronisierung.',
  ...
  sources: {
    ...
    connectBody:
      'Erlaube den Zugriff auf dein Postfach über die offizielle {auth}-Anmeldung, danach kommst du hierher zurück.',
...
const pt: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'Os emails aparecerão aqui na próxima sincronização.',
  ...
  sources: {
    ...
    connectBody:
      'Autorize o acesso à sua caixa através do início de sessão oficial da {auth} e depois volta aqui.',
    authBoth: 'Google ou Microsoft',
    authOutlook: 'Microsoft',
    connectGmail: 'Conectar Gmail',
    connectOutlook: 'Conectar Outlook',
...
const it: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'Le email appariranno qui alla prossima sincronizzazione.',
  ...
  sources: {
    ...
    connectBody:
      'Autorizza l’accesso alla tua casella tramite l’accesso ufficiale {auth}, poi tornerai qui.',
    authBoth: 'Google o Microsoft',
    authOutlook: 'Microsoft',
...
const ar: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'ستظهر الرسائل هنا عند المزامنة التالية.',
  ...
  sources: {
    ...
    connectBody:
      'اسمح بالوصول إلى صندوقك عبر تسجيل الدخول الرسمي من {auth}، ثم تعود إلى هنا.',
...
const ru: Dict = {
  ...
  feed: {
    ...
    emptyDefault: 'Письма появятся здесь при следующей синхронизации.',
  ...
  sources: {
    ...
    connectBody:
      'Разрешите доступ к вашему ящику через официальный вход {auth}, а затем вернитесь сюда.',
