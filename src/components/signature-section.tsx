...
> = {
  ...
  ru: {
    ...
    subtitle: 'Автоматически добавляется внизу ваших черновиков ответов.',
    importBtn: 'Импортировать от провайдера',
    importing: 'Импорт…',
    enabled: 'Включена',
    placeholder: 'Ваше имя, должность, контактные данные…',
    save: 'Сохранить',
    saving: 'Сохранение…',
    saved: 'Подпись сохранена.',
    err: 'Ошибка сети.',
    none: 'Подпись у провайдера не найдена.',
    connect: 'Сначала подключите почтовый ящик.',
  },
};
