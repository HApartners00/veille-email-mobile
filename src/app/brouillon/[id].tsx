...
const styles = StyleSheet.create({
  ...
  // 17/09/2026 — PISTE A DE HA : champs en voile sombre, plus de cartes creme
  // (meme DA que l'Accueil, les Reglages et le detail d'un mail).
  editeur: {
    fontFamily: fonts.sans,
    minHeight: 240,
  ...
  champTexte: { fontFamily: fonts.sans, fontSize: 14, color: colors.onDark },
  pjLigne: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.md,
  ...
  puceText: { fontFamily: fonts.sansMedium, fontSize: 12, color: 'rgba(234,225,208,0.85)' },
